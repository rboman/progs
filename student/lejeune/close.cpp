...
double Q0  = 0.1,     // d‚bit initial
	  ...
	  D   = 0.25,    // diamŠtre de la conduite
	  L   = 400,     // longueur de la conduite
	  a1  = 0,       // cte pompe
	  a   = 1200,    // c‚l‚rit‚ de l'onde
	  f   = 0.02,    // coefficient de frottement
	  tau = 0.6;     // paramŠtre d'ouverture de vanne

int div  = 5,         // nbre de tron‡ons de la conduite
...
ofstream sortie("CLOSE.M", ios::out);   // ouverture fichier MatLab
...
void main()
{
   ...
   sortie << "figure(1); plot(t,H(" << div+1 << ",:),'k'); grid\n";
