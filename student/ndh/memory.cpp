...
{  int i;
   void create_aux();
   alpha = new float[N+1];     xf    = new float[N+1];     yf      = new float[N+1];
   xel   = new float[N];       yel   = new float[N];       xint    = new float[istep+1];
   yint  = new float[istep+1]; u     = new float[N];       q       = new float[N];
   fct   = new float[istep+1]; fct2  = new float[istep+1];
   G1    = new float[N];       H1      = new float[N];
   create_aux();
}
