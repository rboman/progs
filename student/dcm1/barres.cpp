...
void titre()
{
   clrscr();
   puts("            +--------------------------------------+");
   puts("            |  Simulation du m‚canisme … 4 barres  |");
   puts("            |                                      |");
   puts("            |                          RB oct.'94  |");
   puts("            +--------------------------------------+");
}
...
void init()
{
   ...
   zoom=30; ox=150; oy=300;
   a1=1.5; a2=5; a3=3; xb=4.5, ya=3; L=10.5; e=1; dp=0.5;
   pi=3.141592; traj=0;
}
...
void ch_par()
{
   ...
   printf("\n\nxb [%f]=",xb); xb=param(xb);
   printf("ya [%f]=",ya); ya=param(ya);
   printf("a1 [%f]=",a1);a1=param(a1);
   printf("a2 [%f]=",a2);a2=param(a2);
   printf("a3 [%f]=",a3);a3=param(a3);
   printf("L [%f]=",L);L=param(L);
   printf("dp [%f]=",dp);dp=param(dp);
   printf("e [%f]=",e);e=param(e);
   printf("zoom [%f]=",zoom);zoom=param(zoom);
