...
C ----Declarations--------
      ...
      double precision TOL, u, Force(n), Du1(2)
      double precision lambda, Beta, ETA, Du(2), Du2(2)
      double precision x(n), y(n), R(2), uu(2)
...
C           ----Critère de choix de la racine----
...
C        ----Mise à jour des tableaux de résultats----
         t=t+1
         Force(t)=lambda*R(1)
         x(t)=uu(2)
         y(t)=uu(1)
...
C        ----Garde le nombre d'itération max----
         if (imax.LT.i) then
            imax=i
         endif
