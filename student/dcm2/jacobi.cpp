...
//    a Matrice de d‚part dont on cherche les Valeurs Propres
//      (! la diagonale sera modifi‚e aprŠs passage)
//    n Taille de la matrice a
//    d valaurs propres (non ordonn‚es)
//    v modes propres norm‚s correspondants
// nrot nombre de rotations dans la m‚thode
