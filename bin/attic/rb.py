...
# -*- coding: utf-8 -*-
#
# Ancien script utilisé pour lancer mes scripts qui dépendaient de pytools.
# J'utilise maintenant pipx
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Script launcher')  # , add_help=False)
    parser.add_argument('script', help='python script', metavar='script.py')
    parser.add_argument(
        '--banner', help='display info banner', action="store_true")
    parser.add_argument(
        "-v", "--verb", help="increase output verbosity", action="store_true")
    ...
    if ext.lower() == '.py':
        ...
        print(f"I don't know what to do with {args.script}")
