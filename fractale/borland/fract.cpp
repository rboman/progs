...
int main(void)
{
   ...
   puts("\n\t1:------> Mandelbrot");
   puts("\t2:------> Julia");
   puts("\n\t3:------> Modifier paramŠtres");
   puts("\t4:------> Charger paramŠtres");
   puts("\t5:------> Sauver paramŠtres");
   puts("\n\t6:------> Infos");
   puts("\t7:------> Fin");
   printf("\n  Choix \?");
   printf("\n\n\n\nNbre op: %f", no);
...
void modif_param(void)
{
   ...
   printf("\n\n  Choix:");
	 ...
	 case '1':
	    ...
	    /* Teste la validit‚ des paramŠtres */
	    if(x1>x2)
	    {
...
void infos(void)
{
   ...
   puts("    .Am‚lioration de la sauvegarde des paramŠtres.");
