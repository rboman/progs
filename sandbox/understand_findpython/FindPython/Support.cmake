...
message("_${_PYTHON_PREFIX}_FIND_VERSIONS= ${_${_PYTHON_PREFIX}_FIND_VERSIONS}")
...
if ("Interpreter" IN_LIST ${_PYTHON_PREFIX}_FIND_COMPONENTS)
  ...
  foreach (_${_PYTHON_PREFIX}_VERSION IN LISTS _${_PYTHON_PREFIX}_FIND_VERSIONS)
    ...
    message("_${_PYTHON_PREFIX}_FRAMEWORK_PATHS = ${_${_PYTHON_PREFIX}_FRAMEWORK_PATHS}")
    message("${_PYTHON_PREFIX}_ROOT_DIR = ${${_PYTHON_PREFIX}_ROOT_DIR}")
    message("python${_${_PYTHON_PREFIX}_VERSION}")
    set (_${_PYTHON_PREFIX}_HINTS "${${_PYTHON_PREFIX}_ROOT_DIR}" ENV ${_PYTHON_PREFIX}_ROOT_DIR)
    message("_${_PYTHON_PREFIX}_HINTS= ${_${_PYTHON_PREFIX}_HINTS}")
    ...
    message("${_PYTHON_PREFIX}_EXECUTABLE = ${${_PYTHON_PREFIX}_EXECUTABLE}")
