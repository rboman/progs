...
void LittleEndianToNative(char *data, unsigned int size)
{
    if(isLittleEndian())
        return;
    char *sptr = data;
...
void NativeToLittleEndian(char *data, unsigned int size)
{
    LittleEndianToNative(data, size);
}

void BigEndianToNative(char *data, unsigned int size)
{
    if (!isLittleEndian())
        return;
    char *sptr = data;
...
void NativeToBigEndian(char *data, unsigned int size)
{
