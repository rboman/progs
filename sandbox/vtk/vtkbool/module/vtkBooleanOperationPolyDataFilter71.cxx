/*=========================================================================
  ...
  Module:    vtkBooleanOperationPolyDataFilter71.cxx
...
=========================================================================*/
#include "vtkBooleanOperationPolyDataFilter71.h"
...
vtkStandardNewMacro(vtkBooleanOperationPolyDataFilter71);

//------------------------------------------------------------------------------
vtkBooleanOperationPolyDataFilter71::vtkBooleanOperationPolyDataFilter71()
{
  this->Tolerance = 1e-6;
...
//------------------------------------------------------------------------------
vtkBooleanOperationPolyDataFilter71::~vtkBooleanOperationPolyDataFilter71() = default;

//------------------------------------------------------------------------------
void vtkBooleanOperationPolyDataFilter71::SortPolyData(
...
//------------------------------------------------------------------------------
int vtkBooleanOperationPolyDataFilter71::RequestData(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  vtkSmartPointer<vtkIntersectionPolyDataFilter71> PolyDataIntersection =
    vtkSmartPointer<vtkIntersectionPolyDataFilter71>::New();
...
//------------------------------------------------------------------------------
void vtkBooleanOperationPolyDataFilter71::PrintSelf(ostream& os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
int vtkBooleanOperationPolyDataFilter71::FillInputPortInformation(int port, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
void vtkBooleanOperationPolyDataFilter71 ::CopyCells(vtkPolyData* in, vtkPolyData* out, int idx,
