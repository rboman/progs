/*=========================================================================
  ...
  Module:    vtkIntersectionPolyDataFilter71.cxx
...
=========================================================================*/
#include "vtkIntersectionPolyDataFilter71.h"
...
//------------------------------------------------------------------------------
class vtkIntersectionPolyDataFilter71::Impl
{
public:
  Impl();
  virtual ~Impl();
...
public:
  ...
  vtkIntersectionPolyDataFilter71 *ParentFilter;
...
//------------------------------------------------------------------------------
vtkIntersectionPolyDataFilter71::Impl::Impl()
  : OBBTree1(nullptr)
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::Impl ::FindTriangleIntersections(
  vtkOBBNode *node0, vtkOBBNode *node1, vtkMatrix4x4 *transform, void *arg)
{
  vtkIntersectionPolyDataFilter71::Impl *info =
    reinterpret_cast<vtkIntersectionPolyDataFilter71::Impl*>(arg);
      ...
      if (obbTree1->TriangleIntersectsNode(node1, triPts0[0], triPts0[1], triPts0[2], transform))
      {
        ...
        for (vtkIdType id1 = 0; id1 < numCells1; id1++)
        {
          ...
          if (type1 == VTK_TRIANGLE)
          {
            ...
            double surfaceid[2];
            int intersects = vtkIntersectionPolyDataFilter71::TriangleTriangleIntersection(triPts0[0],
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::Impl::SplitMesh(
  int inputIndex, vtkPolyData *output, vtkPolyData *intersectionLines)
{
  ...
  if (input->GetPolys()->GetNumberOfCells() > 0)
  {
    ...
    for (cells->InitTraversal(); cells->GetNextCell(nptsX, pts); cellIdX++)
    {
      if (nptsX != 3)
      {
        vtkGenericWarningMacro(<< "vtkIntersectionPolyDataFilter71 only works"
...
vtkCellArray* vtkIntersectionPolyDataFilter71::Impl::SplitCell(vtkPolyData *input, vtkIdType cellId, 
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::Impl ::AddToPointEdgeMap(int index, vtkIdType ptId, double x[3], 
...
void vtkIntersectionPolyDataFilter71::Impl::AddToNewCellMap( 
  int inputIndex, int interPtCount, int interPts[3], vtkPolyData *interLines, int numCurrCells)
{
  vtkIdList **cellIds;
...
int vtkIntersectionPolyDataFilter71::Impl ::GetLoops(vtkPolyData *pd, std::vector<simPolygon> *loops)
{
...
int vtkIntersectionPolyDataFilter71::Impl ::GetSingleLoop(vtkPolyData* pd, simPolygon* loop,
...
int vtkIntersectionPolyDataFilter71::Impl ::FollowLoopOrientation(vtkPolyData *pd, simPolygon *loop,
...
void vtkIntersectionPolyDataFilter71::Impl ::SetLoopOrientation(vtkPolyData *pd, simPolygon *loop, 
  vtkIdType *nextCell, vtkIdType nextPt, vtkIdType prevPt, vtkIdList *pointCells)
{
...
int vtkIntersectionPolyDataFilter71::Impl::GetLoopOrientation( 
...
void vtkIntersectionPolyDataFilter71::Impl ::Orient(
  vtkPolyData *pd, vtkTransform *transform, vtkPolyData *boundary, vtkPolygon *boundarypoly)
{
...
int vtkIntersectionPolyDataFilter71::Impl::CheckLine(
...
int vtkIntersectionPolyDataFilter71::Impl::GetTransform(vtkTransform *transform, vtkPoints *points)
{
...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkIntersectionPolyDataFilter71);

//------------------------------------------------------------------------------
vtkIntersectionPolyDataFilter71::vtkIntersectionPolyDataFilter71()
  : SplitFirstOutput(1)
  , SplitSecondOutput(1)
{
...
//------------------------------------------------------------------------------
vtkIntersectionPolyDataFilter71::~vtkIntersectionPolyDataFilter71() = default;

//------------------------------------------------------------------------------
void vtkIntersectionPolyDataFilter71::PrintSelf(ostream &os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::TriangleTriangleIntersection(double p1[3], double q1[3],
...
void vtkIntersectionPolyDataFilter71::CleanAndCheckSurface(
...
void vtkIntersectionPolyDataFilter71::CleanAndCheckInput(vtkPolyData *pd, double tolerance)
{
  vtkSmartPointer<vtkCleanPolyData> cleaner = vtkSmartPointer<vtkCleanPolyData>::New();
  vtkSmartPointer<vtkTriangleFilter> triangulator = vtkSmartPointer<vtkTriangleFilter>::New();
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::RequestData(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector*  outputVector)
{
  ...
  // intersections.
  vtkIntersectionPolyDataFilter71::Impl *impl = new vtkIntersectionPolyDataFilter71::Impl();
  ...
  obbTree0->IntersectWithOBBTree(
    obbTree1, nullptr, vtkIntersectionPolyDataFilter71::Impl::FindTriangleIntersections, impl);
...
//------------------------------------------------------------------------------
int vtkIntersectionPolyDataFilter71::FillInputPortInformation(int port, vtkInformation *info)
{
