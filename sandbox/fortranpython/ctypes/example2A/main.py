...
lib.cumsum.argtypes = (np.ctypeslib.ndpointer(dtype='int32',ndim=1,flags='C_CONTIGUOUS'), ctypes.c_int ) 
...
somme = lib.cumsum( np.ctypeslib.as_array(array), len( array ) )
print( 'C interface: ', array )
