...
*                      Starfield 3  (C++ & Asm)                        *
*                                                                      *
* . Utilise le calcul en virgule fixe (2 d‚cimales)		       *
* . Diminution non lin‚aire de la vitesse des ‚toiles                  *
* . Projection centrale                                                *
*							      13.08.96 *	       *                                                                     *
************************************************************************/
...
typedef struct { int pent, pdec; } fixe;
float facdec = 100.0;
...
/*-----------------------------Starfield-------------------------------*/
typedef struct { fixe x, y, plan, xe, ye; } etoiles;
etoiles et[100];
int nb_et;
...
void main()
{
   ...
   fixe c1, c2, c3, c4;
   c1 = int2fix(500,0);         xfuite = int2fix(160,0);
   c2 = int2fix(0,40);          yfuite = int2fix(100,0);
   c3 = int2fix(1,0);
   c4 = int2fix(80,0);
