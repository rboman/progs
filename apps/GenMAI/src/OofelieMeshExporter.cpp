...
void OofelieMeshExporter::writeHeader()
{
...
void OofelieMeshExporter::writeNodes()
{
    fprintf(fich, "# Nodes\n");
    for (auto i = 0; i < mesh.numberOfNodes(); i++)
    {
        fprintf(fich, "nset.define(%d,%lf,%lf,0);\n",
                mesh.getNodeNumber(i), mesh.getNodeX(i), mesh.getNodeY(i));
    }
}

void OofelieMeshExporter::writeElements()
{
    fprintf(fich, "# Elems\n");
...
void OofelieMeshExporter::writeContactElements()
{
    ...
    {
        fprintf(fich, "g1.add_node(%d);\n", mesh.getNodeNumber(k));
    }
}

void OofelieMeshExporter::writeFooter()
{
    fprintf(fich, "\nreturn 0\n};\n\n");
}
