...
void OofelieToolExporter::writeHeader()
{
...
void OofelieToolExporter::writePoints()
{
...
void OofelieToolExporter::writeCurves()
{
...
void OofelieToolExporter::writeContours()
{
    fprintf(fich, "\n# contour\n");
...
void OofelieToolExporter::writeFooter()
{
    fprintf(fich, "\nreturn 0\n};\n\n");
}
