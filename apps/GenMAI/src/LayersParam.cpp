...
void LayersParam::add(LayerType value)
{
...
void LayersParam::load(FILE *file)
{
    Param::load(file);
...
void LayersParam::save(FILE *file) const
{
    Param::save(file);
