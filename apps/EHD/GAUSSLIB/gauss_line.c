...
int gauss_line_get_xgpg(int ng, double **xg, double **pg)
{
  ...
  if(line_xg[ng1] == NULL) {
    ...
    if(line_xg[ng1]==NULL) goto ERR1;
    line_pg[ng1] = (double*)calloc(ng*ng,sizeof(double));
    if(line_pg[ng1]==NULL) goto ERR1;
