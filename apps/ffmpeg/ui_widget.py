...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setToolTip(_translate("Form", "<html><head/><body><p>pattern for the bitmap file names</p><p>anim%4d.bmp =&gt; anim0000.bmp, anim0001.bmp, anim0002.bmp, etc.</p></body></html>"))
