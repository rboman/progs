...
/// This class contains the kernels used in the SPH method.

class KernelF
{
public:
    const double kappa;
    KernelF(double _kappa) : kappa(_kappa)
    {
    }
    virtual ~KernelF() = default;
};

// TODO: futur: envoyer un vecteur de "r" et "h"!

class CubicSplineKernel : public KernelF
{
public:
    CubicSplineKernel();
...
class QuadraticKernel : public KernelF
{
public:
    QuadraticKernel();
    virtual double dW(double r, double h) const
...
class QuinticSplineKernel : public KernelF
{
public:
    QuinticSplineKernel();
    virtual double dW(double r, double h) const
