...
# Script pour convertir un script Python (ou autre langage) en PDF avec 
# syntax highlighting, en utilisant Pandoc.
...
def main(): # Ensure a filename is provided as a command-line argument if len(sys.argv) != 2: print("Usage: python script_to_pdf.py <path_to_python_script>") sys.exit(1)
