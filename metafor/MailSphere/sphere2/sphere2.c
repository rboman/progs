// pour compiler : cc -g -lm -o sphere.x  sphere.c 
...
// PARAMETRES
   ...
   nbe = 5; // nombre d elements sur 1/6 d un méridien 
...
//     }
   ...
   if(type1 == 1){mat1=-mat1 ;}
   if(type2 == 1){mat2=-mat2 ;}
...
// couche 0 (exterieure)
	 ...
	 for (c = 0; c < nbe+1 ; c ++){
	   ...
	   else if(face==4 && c == nbe){tab[0][face][l][c]=tab[0][face-1][0][nbe-l] ;}
...
// remplissage de cube
	 ...
	 for (l = 0; l < nbe+1 ; l ++){
	   for (c = 0; c < nbe+1 ; c ++){
	     if(ep == 0){  cube[ep][l][c]=tab[nbc][0][l][c] ;}
	     else if(ep == nbe){cube[ep][l][c]=tab[nbc][2][l][nbe-c] ;}
	     else if(l  == 0){  cube[ep][l][c]=tab[nbc][4][ep][nbe-c] ;}
	     else if(l  == nbe){cube[ep][l][c]=tab[nbc][5][ep][c] ;}
	     else if(c  == 0){  cube[ep][l][c]=tab[nbc][3][l][nbe-ep] ;}
	     else if(c  == nbe){cube[ep][l][c]=tab[nbc][1][l][ep] ;}
	     else{
	       no=no+1 ;
	       cube[ep][l][c]=no ;
	     }
...
// Couche interieure
	 ...
	 if(cote == 0 || cote == 3){noe1=nn[0] ;}
	 else if(cote == 1){noe1=nn[1] ;}
	 else if(cote == 2){noe1=nn[3] ;}

	 if(cote == 1 || cote == 2){noe2=nn[2] ;}
	 else if(cote == 0){noe2=nn[1] ;}
	 else if(cote == 3){noe2=nn[3] ;}
...
// prise en compte du decoupage
	 ...
	 if(sphere_creuse==0){
       ...
       if(r[1] > 0.){
	 if(status[1][0] != 3){status[1][0]=1  ;}
	 status[2][0]=3  ;
	 status[2][1]=3  ;
	 if(status[3][0] != 3){status[3][0]=2  ;}
	 status[4][1]=1  ;
	 status[5][1]=1  ;
	 if(sphere_creuse==0){
	   status[6][2]=1  ;
	 ...
	 status[0][0]=3  ;
	 status[0][1]=3  ;
	 if(status[1][0] != 3){status[1][0]=2  ;}
	 if(status[3][0] != 3){status[3][0]=1  ;}
	 status[4][1]=2  ;
	 status[5][1]=2  ;
	 if(sphere_creuse==0){
	   status[6][2]=2  ;
       ...
       if(r[2] > 0.){
	 if(status[0][1] != 3){status[0][1]=1  ;}
	 if(status[1][1] != 3){status[1][1]=1  ;}
	 if(status[2][1] != 3){status[2][1]=1  ;}
	 ...
	 if(status[0][1] != 3){status[0][1]=2  ;}
	 if(status[1][1] != 3){status[1][1]=2  ;}
	 if(status[2][1] != 3){status[2][1]=2  ;}
...
//  impression des données du problème
	...
	fprintf(fp_out,"abrev '/rap' '%15.8E' ! Rapport de la diagonale du cube central au rayon exterieur \n",rint) ;
     ...
     fprintf(fp_out,"abrev '/nbc' '%3d' ! Nombre de couches d'éléments (hors cube central si plein) \n",nbc) ;
     fprintf(fp_out,"abrev '/noeini' '%3d' ! Numero du noeud initial - 1\n",noe_ini) ;
     fprintf(fp_out,"abrev '/maiini' '%3d' ! Numero de la maille initiale - 1\n",maille_ini) ;
     if(type1==0){
       fprintf(fp_out,"! Sa surface extérieure est la matrice de contact rigide numero %2d \n",mat1) ;
     }
     if(type1==1){
       fprintf(fp_out,"! Sa surface extérieure est la matrice de contact deformable numero %2d \n",mat1) ;
     }
     if(type2==0){
       fprintf(fp_out,"! Sa surface intérieure est la matrice de contact rigide numero %2d \n",mat2) ;
     }
     if(type2==1){
       fprintf(fp_out,"! Sa surface intérieure est la matrice de contact deformable numero %2d \n",mat2) ;
     }
...
//  impression du .NOE
	 ...
	 if(status[face][0] != 3){
	   ...
	   if(status[face][0] == 1){c_fin=nbe/2 ;}
	   else if(status[face][0] == 2){c_ini=nbe/2 ;}
     ...
     if(sphere_creuse==0){
       ...
       if(status[face][2] == 1){ep_fin=nbe/2 ;}
       else if(status[face][2] == 2){ep_ini=nbe/2 ;}
...
// impression du .MAI
	 ...
	 if(status[face][0] != 3){
	   ...
	   if(status[face][0] == 1){c_fin=nbe/2-1 ;}
	   else if(status[face][0] == 2){c_ini=nbe/2 ;}

	   if(status[face][1] == 1){l_fin=nbe/2-1 ;}
	   else if(status[face][1] == 2){l_ini=nbe/2 ;}
     ...
     if(sphere_creuse==0){
       ...
       if(status[face][2] == 1){ep_fin=nbe/2-1 ;}
       else if(status[face][2] == 2){ep_ini=nbe/2 ;}
...
//   matrice rigide
	 ...
	 for(j=0;j<2;j++){
       ...
       compteur=0 ;
       for(i = 0; i<3 ; i++){
	 if(r[i] != 0){compteur=compteur+1 ;}
       }
       if(compteur == 0){nbnoe=6*nbe*nbe+2 ;}
       else if(compteur == 1){nbnoe=3*nbe*nbe+2*nbe+1 ;}
       else if(compteur == 2){nbnoe=3*nbe*nbe/2+2*nbe+1 ;}
       else if(compteur == 3){nbnoe=3*nbe*nbe/4+3*nbe/2+1 ;}
       n1=noe_ini+1 ;
       n2=n1+nbnoe-1 ;
       i=-1 ;
       out=0 ;
...
//   matrice souple
	 ...
	 if(status[face][0] != 3){
	   ...
	   if(compteur > 0){fprintf(fp_out,"I %6d \n",-4) ;}
	   compteur=compteur+1 ;
...
//   matrice souple
	 ...
	 if(status[face][0] != 3){
	   ...
	   for(l=l_ini; l <= l_fin ; l++) {
	     ...
	     if(l != l_fin){fprintf(fp_out,"I %6d \n",-3) ;}
	   }
	 }
       }
       fprintf(fp_out,"\n") ;
