...
int gauss_hexa_get_xgpg(int ng, double **xg, double **pg)
{
  ...
  if(hexa_xg[ng1] == NULL) {
    ...
    if(hexa_xg[ng1]==NULL) goto ERR1;
    hexa_pg[ng1] = (double*)calloc(ng*ng*ng,sizeof(double));
    if(hexa_pg[ng1]==NULL) goto ERR1;
