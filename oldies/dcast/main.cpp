...
int main()
{
    ...
    A      *objA = dynamic_cast<A*>(obj);        cout << "A = " << objA << endl;
    B<Arg> *objB = dynamic_cast<B<Arg>*>(obj);  cout << "B = " << objB << endl;
    C<Arg> *objC = dynamic_cast<C<Arg>*>(obj);  cout << "C = " << objC << endl;
    D<Arg> *objD = dynamic_cast<D<Arg>*>(obj);  cout << "D = " << objD << endl;
